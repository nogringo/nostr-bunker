...
String commandFromNip46Request(Nip46Request req) {
  final stringifiedCommand = nip46CommandToString(req.command);

  if (req.command != Nip46Commands.signEvent) {
    return stringifiedCommand;
  }

  return "$stringifiedCommand:${jsonDecode(req.params.first)["kind"]}";
}

Future<Nip46Request?> parseNip46Request({
  required Ndk ndk,
